...
echo ""
echo -e "${BLUE}📝 测试备份功能:${NC}"
echo "  1. 创建带助记词的钱包:"
echo "     curl -X POST http://localhost:3000/CreateKey \\"
echo "       -H 'Content-Type: application/json' \\"
echo "       -H 'x-amz-target: TrentService.CreateKey' \\"
echo "       -d '{\"Mnemonic\":\"test wallet backup demo\",\"Description\":\"test\",\"KeyUsage\":\"SIGN_VERIFY\",\"KeySpec\":\"ECC_SECG_P256K1\",\"Origin\":\"AWS_KMS\"}'"
echo ""
echo "  2. 查看备份文件:"
echo "     docker exec teaclave_dev_env ls -lh /opt/teaclave/shared/kms-wallets-backup/"
echo ""
echo "  3. 恢复钱包:"
echo "     ./scripts/kms-restore-wallets.sh /root/shared/kms-wallets-backup/wallet_<UUID>.json"
echo ""
