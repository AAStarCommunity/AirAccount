...
# 确认在 v0.19.3
git log --oneline -1
# 应显示: 095aae2 Merge pull request #30 ...
```
...
# → TA Dev Kit 路径是 /usr/include/optee/export-ta_arm32
...
[ok] Deploy successful!
  Health: {"status":"ok","version":"0.19.3"}
...
部署成功即完成 v0.19.3 的硬件验证。下一步等 i.MX93 到货，流程相同但目标架构改为 `aarch64`，参考 `docs/migration-to-MX95.md`。
